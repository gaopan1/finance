...
public class SWAT809Test extends ServiceSuperTestClass {
	...
	public SWAT809Test(String store, String parentIDValue, String contextValue,
	...
	public void DemoScriptRun(ITestContext ctx) {
		try {
			...
			super.paraString = "Verify not visible-"+"type = "+modelParameter+"; visibility ="+VisibilityParameter+" ;parentID=" + parentID + ";contextString="
					+ contextString + ";";
		...
		assert !tempCode.equals(expectedProductNumber);
