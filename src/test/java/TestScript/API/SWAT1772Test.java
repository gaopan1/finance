...
public class SWAT1772Test extends ServiceSuperTestClass {
	...
	public SWAT1772Test(String store, String productNo, String context,
			String contextParam, String productT, String stackableValue,
			String costP, String floorP, String listP, String webP, String tax,
			String SD, String currency) {
		this.Store = store;
		...
		this.testName = "SWAT-1772";
		super.serviceName = "getB2BPrice";
	}
	...
	public void DemoScriptRun(ITestContext ctx) {
		try {
			...
			if (!expectedtax.equals("")) {
				String tempTaxPrice = hCommon.getJsonValue(taxJSON, "formattedPrice");
