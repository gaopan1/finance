...
public class SWAT1009Test extends ServiceSuperTestClass {
...
private String productType;
	...
	public SWAT1009Test(String store, String productNo, String context,
			String contextParam,String productT,String stackableValue, String costP, String floorP, String couponP,
			String salesP, String listP, String webP, String tax,
			String currency) {
		this.Store = store;
	...
	public void DemoScriptRun(ITestContext ctx) {
		try {
			...
			super.paraString ="Product type is "+productType+ " ;Product Code=" + productCode + " ;context="
					+ ContextString;
			...
			if (!expectedCostPice.equals("")) {
				...
				assert tempCostPrice.equals(expectedCostPice):"actual CostPrice is "+tempCostPrice;
				...
				assert tempfloorPrice.equals(expectedfloorPice):"actual floorPrice is "+tempfloorPrice;
				//assert tempcurrency.equals(expectedCurrency);
			}
				...
				assert tempCouponPrice.equals(expectedcouponPice):"actual  CouponPrice is "+tempCouponPrice;
				assert tempcurrency.equals(expectedCurrency);
			...
			if (!expectedsalesPice.equals("")) {
				...
				assert tempSalesPrice.equals(expectedsalesPice):"actual  SalesPrice is "+tempSalesPrice;
				assert tempcurrency.equals(expectedCurrency);
			...
			if (!expectedlistPice.equals("")) {
				...
				assert templistedPrice.equals(expectedlistPice):"actual listPice is "+templistedPrice;
				//assert tempcurrency.equals(expectedCurrency);
			...
			if (!expectedwebPice.equals("")) {
				...
				assert tempWebPrice.equals(expectedwebPice):"actual webPice is "+tempWebPrice;
				//assert tempcurrency.equals(expectedCurrency);
	
			}
			
			if (!expectedtax.equals("")) {
				String tempTaxPrice = hCommon.getJsonValue(taxJSON,
						"price");
				 tempcurrency = hCommon.getJsonValue(taxJSON,"currency");
				 tempTaxPrice=format1( Double.parseDouble(tempTaxPrice));
				assert tempTaxPrice.equals(expectedtax):tempTaxPrice+"actual tax is "+tempTaxPrice;
				//assert tempcurrency.equals(expectedCurrency);
