...
public class ABTestThread1 implements Runnable{
	...
	public  void run(){
		...
		try{
			...
			for(x=0; x<len;x++){
				...
				synchronized(ABTestThread1.class){
...
//					Dailylog.logInfo("result is :" + result);
					...
					System.out.println("x is :::::::" + x + "Thread is：" + Thread.currentThread().getName());
	...
	public static ArrayList<String> getUdid(){
		...
		String sql = "select * from abtest_udid where id <51396";
