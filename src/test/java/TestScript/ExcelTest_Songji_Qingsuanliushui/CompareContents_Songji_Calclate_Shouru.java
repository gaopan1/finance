...
public class CompareContents_Songji_Calclate_Shouru {
	...
	public CompareContents_Songji_Calclate_Shouru(String sourceFile,
	...
	public void test() throws Exception{
        ...
        for(int x =1; x<=rowLength-1;x++){
        	...
        	XSSFCell calculateCell = null;
        	 ...
        	 double calculate_result_shouru = dou_yingjiesuanjine*0.04;
        	 calculate_result_shouru = WriterExcelUtil.getValidNumbersOfDouble(calculate_result_shouru, "2.11");
        	 
        	 
        	 Dailylog.logInfo("calculate_result_shouru is ：" + calculate_result_shouru);
        	 
        	 
        	 if(calculate_result_shouru != dou_shouru){
