...
public class CompareContents_Songji_Calclate_Jiesuanjine {
	...
	public CompareContents_Songji_Calclate_Jiesuanjine(String sourceFile,
	...
	public void test() throws Exception{
        ...
        for(int x =1; x<=rowLength-1;x++){
        	...
        	XSSFCell calculateCell = null;
        	 ...
        	 double dou_jiesuanjine = WriterExcelUtil.getFloatPrice(jiesuanjine_Str);
        	 double dou_yingjiesuanjine = WriterExcelUtil.getFloatPrice(yingjiesuanjine_Str);
        	 double dou_shouru = WriterExcelUtil.getFloatPrice(shouru_Str);
        	 ...
        	 double calculate_result_jiesuanjine = dou_yingjiesuanjine-dou_shouru;
        	 calculate_result_jiesuanjine = WriterExcelUtil.getValidNumbersOfDouble(calculate_result_jiesuanjine, "2.11");
        	 
        	 
        	 Dailylog.logInfo("calculate_result_jiesuanjine is ：" + calculate_result_jiesuanjine);
        	 
        	 
        	 if(calculate_result_jiesuanjine != dou_jiesuanjine){
