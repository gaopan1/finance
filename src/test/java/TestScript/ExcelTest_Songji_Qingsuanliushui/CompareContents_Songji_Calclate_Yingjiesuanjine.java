...
public class CompareContents_Songji_Calclate_Yingjiesuanjine {
	...
	public CompareContents_Songji_Calclate_Yingjiesuanjine(String sourceFile,
	...
	public void test() throws Exception{
        ...
        for(int x =1; x<=rowLength-1;x++){
        	...
        	XSSFCell calculateCell = null;
        	 ...
        	 double dou_zhifujine = WriterExcelUtil.getFloatPrice(zhifujine_Str);
        	 double dou_butie = WriterExcelUtil.getFloatPrice(butie_Str);
        	 
        	 Dailylog.logInfo("dou_yingjiesuanjine is :" + dou_yingjiesuanjine);
        	 Dailylog.logInfo("dou_zhifujine is :" + dou_zhifujine);
        	 Dailylog.logInfo("dou_butie is :" + dou_butie);
        	 
        	 double calculate_result_yingjiesuanjine = dou_zhifujine + dou_butie;
        	 
        	 Dailylog.logInfo("calculate_result_yingjiesuanjine is ：" + calculate_result_yingjiesuanjine);
        	 
        	 
        	 if(calculate_result_yingjiesuanjine != dou_yingjiesuanjine){
        		 list = new ArrayList<String>();
        		 
        		 list.add(yingjiesuanjine_Str);
        		 list.add(zhifujine_Str);
        		 list.add(butie_Str);
