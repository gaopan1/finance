...
public class NA25656Test extends SuperTestClass {
	...
	public NA25656Test(String store){
		this.Store = store;
		this.testName = "NA-25656";
	}
	...
	public void NA18960(ITestContext ctx){
		try{
			...
			SimulationToolAriba(6,Domain,Identity,SharedSecret,defaultUnit);
			...
			Description=driver.findElement(By.xpath(".//*[@id='orderList']/xmp[1]")).getText().split("Description")[2];
			SupplierPartID=driver.findElement(By.xpath(".//*[@id='orderList']/xmp[1]")).getText().split("<SupplierPartID>")[1].split("</SupplierPartID>")[0];
			System.out.println(CardId);
			System.out.println(SupplierPartID);
			if(Description.contains(SupplierPartID) && Description.contains(CardId)){
				Assert.assertEquals(true,true);
			}
			Dailylog.logInfoDB(7,"Purchase one product and check cartMessage", Store,testName);
			
			driver.manage().deleteAllCookies();
			driver.get(testData.HMC.getHomePageUrl());
			HMCCommon.Login(hmcPage, testData);
			
			SetRule9notCheck(B2BCustomer);
			Dailylog.logInfoDB(8,"Modify Punchout Profile", Store,testName);
			...
			Description=driver.findElement(By.xpath(".//*[@id='orderList']/xmp[1]")).getText().split("Description")[2];
			SupplierPartID=driver.findElement(By.xpath(".//*[@id='orderList']/xmp[1]")).getText().split("<SupplierPartID>")[1].split("</SupplierPartID>")[0];
			if(!Description.contains("SupplierPartID")){
				Assert.assertEquals(true,true);
			}
	...
	public void saveOCICart(String serviceNumber) throws InterruptedException{
		...
		Common.sleep(12000);
		Common.scrollToElement(driver, driver.findElement(By.xpath(".//*[@id='addToCartForm"+serviceNumber+"']/button")));
