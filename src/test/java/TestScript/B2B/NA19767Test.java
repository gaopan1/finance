...
public class NA19767Test extends SuperTestClass {
	...
	String B2BCustomer = "NA-14465-001";
	String Code = "NA-14465-001";
	String B2BCustomerGroups = "punchOutCustomer";
	String serviceNumber="5PS0A23057";
	
	public NA19767Test(String store){
		this.Store = store;
		this.testName = "NA-19767";
	}
	
	@Test(alwaysRun = true, groups = {"contentgroup", "b2bpunchout", "p2", "b2b"})
	public void NA19767(ITestContext ctx){
		try{
			this.prepareTest();
			...
			String UserName = "NA-14465-001";
			String Password = "aaa";
			String ProfileName = "NA-14465-001";
			...
			Dailylog.logInfoDB(4,"Create Punchout Credential -OCI , and check if exist, edit it.", Store,testName);
			checkPunchoutCredential(driver,hmcPage,B2BCustomer,Code,UserName,Password);
...
//		
			Dailylog.logInfoDB(8,"Simulation Tool OCI Request Method select Post ande Click", Store,testName);
			SimulationToolOCI(UserName,Password,defaultUnit,"Post");
//
			Dailylog.logInfoDB(9,"Add one product to cart and click Checkout", Store,testName);
			saveOCICart(serviceNumber);
			Assert.assertTrue(punchoutPage.OCI_OrderList.getText().contains(serviceNumber));
//			
			
			Dailylog.logInfoDB(10,"Simulation Tool OCI Request Method select Get ande Click", Store,testName);
			SimulationToolOCI(UserName,Password,defaultUnit,"Get");
			
			Dailylog.logInfoDB(11,"Add one product to cart and click Checkout", Store,testName);
			saveOCICart(serviceNumber);
			Assert.assertTrue(punchoutPage.OCI_OrderList.getText().contains(serviceNumber));
	...
	public void SimulationToolOCI(String UserName,String Password,String defaultUnit,String requestMethod){
	...
	public void  checkPunchoutCredential(WebDriver driver,HMCPage hmcPage,String B2BCustomer,String Code,String UserName,String Password) throws InterruptedException{
		...
		if(Common.isElementExist(driver, By.xpath(xpath))){
			...
			if(Common.checkElementExists(driver, hmcPage.PunchoutCredential_1stSearchedResult, 10)){
				...
				editPunchoutCredential(driver,hmcPage,B2BCustomer,Code,UserName,Password);
			} else {
				creatPunchoutCredential(driver,hmcPage,B2BCustomer,Code,UserName,Password);
			}
		} else {
			creatPunchoutCredential(driver,hmcPage,B2BCustomer,Code,UserName,Password);
		}
	...
	public void creatPunchoutCredential(WebDriver driver,HMCPage hmcPage,String B2BCustomer,String Code,String UserName,String Password) throws InterruptedException{
	...
	public void editPunchoutCredential(WebDriver driver,HMCPage hmcPage,String B2BCustomer,String Code,String UserName,String Password) throws InterruptedException{
