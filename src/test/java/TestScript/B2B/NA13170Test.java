...
public class NA13170Test extends SuperTestClass {
	...
	String B2BCustomer = "PUNCHOUT-13170";
	String B2BCustomerGroups = "punchOutCustomer";
	int logResult = 0;
	String quantity="3";
	String message = "Unfortunately your session has been expired.";
	
	public NA13170Test(String store){
		this.Store = store;
		this.testName = "NA-13170";
	}
	
	@Test(alwaysRun = true, groups = {"contentgroup", "b2bpunchout", "p2", "b2b"})
	public void NA13170(ITestContext ctx){
		try{
			this.prepareTest();
			...
			SimulationToolOracle(8,UserName,Password,defaultUnit);
			...
			saveOCICart(defaultMTMPN1);
			Dailylog.logInfoDB(9,"Add product", Store,testName);
			
			Common.sleep(2100000);
			Common.javascriptClick(driver, b2bPage.HomePage_CartIcon);
			Common.sleep(3000);
			Assert.assertTrue(driver.findElement(By.xpath("//strong/font")).getText().contains(message));
			Dailylog.logInfoDB(10,"Waiting session timeout", Store,testName);
