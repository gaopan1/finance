...
public class NA13158Test extends SuperTestClass {
	public String Punchout_Ariba_URL;
	public String HMCURL;
	private HMCPage hmcPage;
	private B2BPunchoutPage punchoutPage;
	...
	public NA13158Test(String Store){
		this.Store = Store;
		this.testName = "NA-13158";
	}
	
	@Test(alwaysRun = true, groups = {"contentgroup", "b2bpunchout", "p2", "b2b"})
	public void NA13158(ITestContext ctx){
		try{
			this.prepareTest();
			...
			String Identity = "8944-001";
			String SharedSecret = "aaa";
			String Code = "8944-001";
			String UserName = "8944-001";
			String Password = "aaa";
			String name = "8944-001-01";
			String nameerr = "8944-001-1";
			String ProfileName = "8944-001#NA#defaultsoldto-No1";
			String ProfileName2 = "8944-001#NA#defaultsoldto-No2";
			String[]  BundleRules1= {"2_operatingUnit_002_1213410863",
					"3_operatingUnit_003_1213521232",
					};
			String[]  BundleRules2= {"2_operatingUnit_004_1213521232",
					"3_operatingUnit_005_1213410863",
					};
			
			String B2BCustomer = "8944-001";
			...
			checkPunchoutProfile(ProfileName,B2BCustomer,BundleRules1);
			...
			Dailylog.logInfoDB(6,"Create punchout profile①，and check if exist, edit it.", Store,testName);
			checkPunchoutProfile(ProfileName2,B2BCustomer,BundleRules2);
			
			Dailylog.logInfoDB(7,"8,Simulation Tool", Store,testName);
			SimulationToolOracle(8,UserName,Password,defaultUnit,name,nameerr);
			
			Dailylog.logInfoDB(9,"Simulation Tool", Store,testName);
			SimulationToolOracle(9,UserName,Password,defaultUnit,name,nameerr);
			
			Dailylog.logInfoDB(10,"Simulation Tool", Store,testName);
			SimulationToolOracle(10,UserName,Password,defaultUnit,name,nameerr);
			
			Dailylog.logInfoDB(11,"Simulation Tool", Store,testName);
			SimulationToolOracle(11,UserName,Password,defaultUnit,name,nameerr);
			
			Dailylog.logInfoDB(12,"Simulation Tool", Store,testName);
			SimulationToolOracle(12,UserName,Password,defaultUnit,name,nameerr);
			
			Dailylog.logInfoDB(13,"Simulation Tool", Store,testName);
			SimulationToolOracle(13,UserName,Password,defaultUnit,name,nameerr);
			
			Dailylog.logInfoDB(14,"Simulation Tool", Store,testName);
			SimulationToolOracle(14,UserName,Password,defaultUnit,name,nameerr);
	...
	public void SimulationToolOracle(int step,String Name,String Password,String defaultUnit,String name,String nameerr){
		...
		if(step == 9) {
			String loginRequestText = punchoutPage.Oracle_LoginRequestTextBox.getText().replaceFirst("<username />", "<username>"+name+"</username>");
			loginRequestText = loginRequestText.replaceFirst("<password>welcome</password>", "<password>"+Password+"</password>");
			loginRequestText = loginRequestText.replaceFirst("<companyName>Buyer Corp.</companyName>", "<companyName>"+Name+"</companyName>");
			punchoutPage.Oracle_LoginRequestTextBox.clear();
			punchoutPage.Oracle_LoginRequestTextBox.sendKeys(loginRequestText);
			punchoutPage.Oracle_PunchoutButton.click();
			Common.sleep(1000);
		...
		if(step == 10) {
			String loginRequestText = punchoutPage.Oracle_LoginRequestTextBox.getText().replaceFirst("<username />", "<username>"+nameerr+"</username>");
			loginRequestText = loginRequestText.replaceFirst("<password>welcome</password>", "<password>"+Password+"</password>");
			loginRequestText = loginRequestText.replaceFirst("<companyName>Buyer Corp.</companyName>", "<companyName>"+nameerr+"</companyName>");
			punchoutPage.Oracle_LoginRequestTextBox.clear();
			punchoutPage.Oracle_LoginRequestTextBox.sendKeys(loginRequestText);
			punchoutPage.Oracle_PunchoutButton.click();
			Common.sleep(1000);
			Assert.assertTrue(driver.findElement(By.xpath("//body/div[1]")).getText().contains("Status code E"));
		}
		
		if(step == 11) {
			String loginRequestText = punchoutPage.Oracle_LoginRequestTextBox.getText().replaceFirst("<username />", "<username>"+Name+"</username>");
			loginRequestText = loginRequestText.replaceFirst("<password>welcome</password>", "<password>"+Password+"</password>");
			loginRequestText = loginRequestText.replaceFirst("<operatingUnit>204</operatingUnit>", "<operatingUnit>002</operatingUnit>");
			punchoutPage.Oracle_LoginRequestTextBox.clear();
			punchoutPage.Oracle_LoginRequestTextBox.sendKeys(loginRequestText);
			punchoutPage.Oracle_PunchoutButton.click();
			Common.sleep(1000);
			driver.switchTo().frame(driver.findElement(By.id("displayFrame")));
			Common.sleep(5000);
			assert punchoutPage.Lenovo_Link.getAttribute("href").contains("1213410863");
		}
		
		if(step == 12) {
			String loginRequestText = punchoutPage.Oracle_LoginRequestTextBox.getText().replaceFirst("<username />", "<username>"+Name+"</username>");
			loginRequestText = loginRequestText.replaceFirst("<password>welcome</password>", "<password>"+Password+"</password>");
			loginRequestText = loginRequestText.replaceFirst("<operatingUnit>204</operatingUnit>", "<operatingUnit>003</operatingUnit>");
			punchoutPage.Oracle_LoginRequestTextBox.clear();
			punchoutPage.Oracle_LoginRequestTextBox.sendKeys(loginRequestText);
			punchoutPage.Oracle_PunchoutButton.click();
			Common.sleep(1000);
			driver.switchTo().frame(driver.findElement(By.id("displayFrame")));
			Common.sleep(5000);
			assert punchoutPage.Lenovo_Link.getAttribute("href").contains("1213521232");
		}
		
		if(step == 13) {
			String loginRequestText = punchoutPage.Oracle_LoginRequestTextBox.getText().replaceFirst("<username />", "<username>"+Name+"</username>");
			loginRequestText = loginRequestText.replaceFirst("<password>welcome</password>", "<password>"+Password+"</password>");
			loginRequestText = loginRequestText.replaceFirst("<operatingUnit>204</operatingUnit>", "<operatingUnit>004</operatingUnit>");
			punchoutPage.Oracle_LoginRequestTextBox.clear();
			punchoutPage.Oracle_LoginRequestTextBox.sendKeys(loginRequestText);
			punchoutPage.Oracle_PunchoutButton.click();
			Common.sleep(1000);
		...
		if(step == 14) {
			String loginRequestText = punchoutPage.Oracle_LoginRequestTextBox.getText().replaceFirst("<username />", "<username>"+Name+"</username>");
			loginRequestText = loginRequestText.replaceFirst("<password>welcome</password>", "<password>"+Password+"</password>");
			loginRequestText = loginRequestText.replaceFirst("<operatingUnit>204</operatingUnit>", "<operatingUnit>005</operatingUnit>");
			punchoutPage.Oracle_LoginRequestTextBox.clear();
			punchoutPage.Oracle_LoginRequestTextBox.sendKeys(loginRequestText);
			punchoutPage.Oracle_PunchoutButton.click();
			Common.sleep(1000);
