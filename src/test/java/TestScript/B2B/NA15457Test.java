...
public class NA15457Test extends SuperTestClass {
	...
	String B2BCustomer = "PUNCHOUT-15457";
	String B2BCustomerGroups = "punchOutCustomer";
	int logResult = 0;


	
	public NA15457Test(String store){
		this.Store = store;
		this.testName = "NA-15457";
	}
	
	@Test(alwaysRun = true, groups = {"contentgroup", "b2bpunchout", "p2", "b2b"})
	public void NA15457(ITestContext ctx){
		try{
			this.prepareTest();
			...
			aribaUrl= "https://service.ariba.com/Supplier.aw/128478091/aw?awh=r&awssk=wFmy9eYR&dard=1";
//			punchOutURL=testData.B2B.getHomePageUrl().split("le/")[0]+"punchout/cxml/setup";
			punchOutURL = "https://pre-c-hybris.lenovo.com/le/punchout/cxml/setup";
			String UserName = "PUNCHOUT-15457";
			String Password = "aaa";

			
			//PunchOut Credential:Code Domain Identity SharedSecret
			String Code = "PUNCHOUT-15457";
			String Domain = "NetworkID";
			String Identity = "PUNCHOUT-15457";
			String SharedSecret = "aaa";
			
			//OCI and Oracle : Code UserName Password
			
			//Profile: ProfileName UserName
			String ProfileName = "PUNCHOUT-15457";
			
			
			//
			String aribaName="test-LENOVOAUS2ADMIN@lenovo.com";
			String ariPassword="March2016";
			...
			Dailylog.logInfoDB(1,"Create Punchout Profile, and check if exist, remove it then create again successfully.", Store,testName);
			
			setAribaPunchoutUrl(aribaName,ariPassword,punchOutURL);
	...
	public void setAribaPunchoutUrl(String aribaName,String ariPassword,String punchOutURL) throws InterruptedException{
		driver.get(aribaUrl);
		B2BCommon.punchoutLogin(driver,punchoutPage);
		driver.findElement(By.name("UserName")).sendKeys(aribaName);
		driver.findElement(By.id("Password")).sendKeys(ariPassword);
		driver.findElement(By.xpath("//input[@type='submit']")).click();
		Dailylog.logInfoDB(2,"Log in Ariba", Store,testName);
		
		
		driver.findElement(By.id("myid")).click();		
		driver.findElement(By.id("sgntransact_6")).click();
		
		//Configure cXML
		driver.findElement(By.xpath("//div[@class='linkAccountClass' and contains(.,'cXML')]")).click();
		Common.sleep(3000);
		//PunchOutSetupRequest URL
		driver.findElement(By.id("_iohdr")).clear();	
		driver.findElement(By.id("_iohdr")).sendKeys(punchOutURL);
		
		//saveBT
		driver.findElement(By.xpath("//button[@id='_sd2i7']")).click();
//		driver.findElement(By.id("_sd2i7")).click();
		Dailylog.logInfoDB(3,"Set punchout url", Store,testName);
		
		//closeBT
		Common.sleep(8000);
		driver.findElement(By.id("_m8r1tb")).click();
		Thread.sleep(3000);
		//catalog Tab
		driver.findElement(By.id("_ciaxb")).click();
		//LenovoAustrlia -cXml
		driver.findElement(By.xpath("//tr[@id='_pzja5c']/td[contains(.,'cXML')]")).click();
		//run
//		driver.findElement(By.id("_rplnxc")).click();
		driver.findElement(By.id("_e5qttc")).click();
		Dailylog.logInfoDB(4,"Punchout", Store,testName);
	...
	public void saveServiceProductCart(String partNumber,String BagsPartNumber) throws InterruptedException{
		//Link
		driver.findElement(By.xpath("//span[contains(text(),'Accessories')]")).click();
		//Accessories bags
		driver.findElement(By.xpath("//img[contains(@title,'Cases & Bags')]")).click();
		//select Bags Part Number
		driver.findElement(By.xpath(".//*[@id='addToCartForm"+BagsPartNumber+"']/button")).click();
