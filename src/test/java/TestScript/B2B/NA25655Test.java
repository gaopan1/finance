...
public class NA25655Test extends SuperTestClass {
	...
	String B2BCustomer = "NA-22602-001";
	String B2BCustomerGroups = "punchOutCustomer";
	int logResult = 0;
	String serviceNumber="5PS0F15928";
	String CardId="";
	
	public NA25655Test(String store){
		this.Store = store;
		this.testName = "NA-25655";
	}
	...
	public void NA18960(ITestContext ctx){
		try{
			...
			cmlUrl= "https://equallevel.com/punchout/cxml-punchout-tester";

			String UserName = "NA-22602-001";
			String Password = "aaa";

			
			//PunchOut Credential:Code Domain Identity SharedSecret
			String Code = "NA-22602-001";
			String Domain = "NetworkID";
			String Identity = "NA-22602-001";
			String SharedSecret = "aaa";
			
			//OCI and Oracle : Code UserName Password

			//Profile: ProfileName UserName
			String ProfileName = "NA-22602-001";
			...
			driver.get(cmlUrl);
			SetCXMLPunchoutTester(Domain,B2BCustomer,SharedSecret);
			Dailylog.logInfoDB(6,"Use Equallevel do test", Store,testName);
			
			switchToWindow(1);
			saveOCICart(serviceNumber);
			Dailylog.logInfoDB(7,"Buy one product", Store,testName);
	...
	public void saveOCICart(String serviceNumber) throws InterruptedException{
		...
		driver.findElement(By.xpath(".//*[@id='bd']/table/tbody/tr/td[2]")).getText();
		Assert.assertEquals(driver.findElement(By.xpath(".//*[@id='bd']/table/tbody/tr/td[2]")).getText(), serviceNumber);
		
	}
	public void SetCXMLPunchoutTester(String Domain,String B2BCustomer,String SharedSecret) throws InterruptedException{
			driver.findElement(By.id("url")).clear();
			driver.findElement(By.id("url")).sendKeys("https://pre-c-hybris.lenovo.com/le/punchout/cxml/setup");
			
			driver.findElement(By.id("value0")).clear();
			driver.findElement(By.id("value0")).sendKeys(Domain);
			
			driver.findElement(By.id("value1")).clear();
			driver.findElement(By.id("value1")).sendKeys(B2BCustomer);
			
			driver.findElement(By.id("value2")).clear();
			driver.findElement(By.id("value2")).sendKeys("x");
			driver.findElement(By.id("value3")).clear();
			driver.findElement(By.id("value3")).sendKeys("x");
			driver.findElement(By.id("value4")).clear();
			driver.findElement(By.id("value4")).sendKeys("x");
			driver.findElement(By.id("value5")).clear();
			driver.findElement(By.id("value5")).sendKeys("x");
			
			driver.findElement(By.id("value6")).clear();
			driver.findElement(By.id("value6")).sendKeys(SharedSecret);
