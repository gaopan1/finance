...
public class NA13519Test extends SuperTestClass {
	...
	String B2BCustomer = "NA-13519-001";
	...
	public NA13519Test(String store){
		this.Store = store;
		this.testName = "NA-13519";
	}
	
	@Test(alwaysRun = true, groups = {"contentgroup", "b2bpunchout", "p2", "b2b"})
	public void NA13519(ITestContext ctx){
		try{
			this.prepareTest();
			...
			String UserName = "NA-13519-001";
			String Password = "aaa";

			tagRules.add(new String[]{"response/body/OrderLinesDataElements/orderLine/add_productId","aa-#productId-bb"});
			tagRules.add(new String[]{"response/body/OrderLinesDataElements/orderLine/add_cartId","aa-#cartId-bb"});
			tagRules.add(new String[]{"response/body/OrderLinesDataElements/orderLine/add_contractId","aa-#contractId-bb"});
			tagRules.add(new String[]{"response/body/OrderLinesDataElements/orderLine/add_description","aa-#description-bb"});
			tagRules.add(new String[]{"response/body/OrderLinesDataElements/orderLine/add_currency","aa-#currency-bb"});
			tagRules.add(new String[]{"response/body/OrderLinesDataElements/orderLine/add_itemPrice","aa-#itemPrice-bb"});
			tagRules.add(new String[]{"response/body/OrderLinesDataElements/orderLine/add_commodityCode","aa-#commodityCode-bb"});
			tagRules.add(new String[]{"response/body/OrderLinesDataElements/orderLine/add_unspscCode","aa-#unspscCode-bb"});
			tagRules.add(new String[]{"response/body/OrderLinesDataElements/orderLine/add_operatingUnit","aa-#operatingUnit-bb"});
			tagRules.add(new String[]{"response/body/OrderLinesDataElements/orderLine/add_MCN","aa-#MCN-bb"});
			tagRules.add(new String[]{"response/body/OrderLinesDataElements/orderLine/additionalAttributes","blank"});
			
			attributeRules.add(new String[]{"response/body/OrderLinesDataElements/orderLine/additionalAttributes","att_productId","aa-#productId-bb"});
			attributeRules.add(new String[]{"response/body/OrderLinesDataElements/orderLine/additionalAttributes","att_cartId","aa-#cartId-bb"});
			attributeRules.add(new String[]{"response/body/OrderLinesDataElements/orderLine/additionalAttributes","att_contractId","aa-#contractId-bb"});
			attributeRules.add(new String[]{"response/body/OrderLinesDataElements/orderLine/additionalAttributes","att_description","aa-#description-bb"});	
			attributeRules.add(new String[]{"response/body/OrderLinesDataElements/orderLine/additionalAttributes","att_currency","aa-#currency-bb"});
			attributeRules.add(new String[]{"response/body/OrderLinesDataElements/orderLine/additionalAttributes","att_itemPrice","aa-#itemPrice-bb"});
			attributeRules.add(new String[]{"response/body/OrderLinesDataElements/orderLine/additionalAttributes","att_commodityCode","aa-#commodityCode-bb"});
			attributeRules.add(new String[]{"response/body/OrderLinesDataElements/orderLine/additionalAttributes","att_unspscCode","aa-#unspscCode-bb"});	
			attributeRules.add(new String[]{"response/body/OrderLinesDataElements/orderLine/additionalAttributes","att_operatingUnit","aa-#operatingUnit-bb"});
			attributeRules.add(new String[]{"response/body/OrderLinesDataElements/orderLine/additionalAttributes","att_MCN","aa-#MCN-bb"});

			
			//PunchOut Credential:Code Domain Identity SharedSecret
			String Code = "NA-13519-001";
			String Domain = "NetworkID";
			String Identity = "NA-13519-001";
			String SharedSecret = "aaa";
			
			//OCI and Oracle : Code UserName Password

			//Profile: ProfileName UserName
			String ProfileName = "NA-13519-001";
			...
			for(int a=0;a<attributeRules.size();a++){			
				Assert.assertEquals(true, punchoutPage.OCI_OrderList.getText().contains(attributeRules.get(a)[1]));
			}
...
//					+ "td[last()]//table//table/tbody/tr[last()]//table//input)[5]")).click();
	...
	public void saveOCICart(String serviceNumber) throws InterruptedException{
		...
		Thread.sleep(5000);
		Common.javascriptClick(driver, driver.findElement(By.xpath((".//*[@id='addtoCartModal"+serviceNumber+"']/aside/div[3]/a[2]"))));
