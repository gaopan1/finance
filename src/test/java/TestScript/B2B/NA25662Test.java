...
public class NA25662Test extends SuperTestClass {
	...
	String B2BCustomer = "NA-25662-001";
	String B2BCustomerGroups = "punchOutCustomer";
	int logResult = 0;
	String serviceNumber="5PS0F15928";

	
	public NA25662Test(String store){
		this.Store = store;
		this.testName = "NA-25662";
	}
	...
	public void NA18960(ITestContext ctx){
		try{
			...
			Common.sleep(3000);
			//check 25662
			Assert.assertEquals(false,driver.findElement(By.xpath(".//*[@id='orderList']/xmp[1]")).getText().contains("<SupplierID>"));
			Dailylog.logInfoDB(7,"Checkout succeed and check cartMessage there is no <SupplierID> tab. .", Store,testName);
	...
	public void creatPunchoutProfile(String ProfileName,String B2BCustomer) throws InterruptedException{
		...
		//NA-25662
		driver.findElement(By.id("Content/BooleanEditor[in Content/Attribute[.isCustomCart]]_checkbox")).click();
		driver.findElement(By.id("Content/BooleanEditor[in Content/Attribute[.isSupplierIDRemoved]]_checkbox")).click();
