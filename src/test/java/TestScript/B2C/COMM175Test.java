...
public class COMM175Test extends SuperTestClass {
	...
	public COMM175Test(String Store) {
		this.Store = Store;

		this.testName = "COMM-175";
	}
	...
	public void COMM175(ITestContext ctx) {
...
//			switchUiCart(true, pk);
	...
	private void createNewProfile() {
		...
		// B2C Properties
		String profileName = "Card Profile 175";
