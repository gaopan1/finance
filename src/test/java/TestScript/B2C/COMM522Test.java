...
public class COMM522Test extends SuperTestClass {
	...
	private String profileName = "PO Profile 522";
	public COMM522Test(String Store) {
		this.Store = Store;

		this.testName = "COMM-522";
	}
	...
	public void COMM522(ITestContext ctx) {
