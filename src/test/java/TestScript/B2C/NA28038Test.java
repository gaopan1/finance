...
public class NA28038Test extends SuperTestClass{
	private HMCPage hmcPage;
	private B2CPage b2cPage;

	public NA28038Test(String store) {
		this.Store = store;
		this.testName = "NA-28038";
	}

	@Test(priority = 0,alwaysRun = true, groups = {"browsegroup","uxui",  "p2", "b2c"})
	public void NA28038(ITestContext ctx) throws Exception {
		try{
			this.prepareTest();
