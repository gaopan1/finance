...
public class Data extends B2CData {
	...
	public String getHomePageUrl() {
		return TestData.PreC.EnvData.HttpsDomain + "/in/en";
	}
	...
	public String getDefaultMTMPN() {
		...
		return "";
			...
			MTM = daoService.getProductNB("IN", "MTM","PreC");
	...
	public String getDefaultAccessoryPN() {
		if (ACC != null) {
			...
			ACC = daoService.getProductNB("IN", "Accessory","PreC");
	...
	public String getResetPasswordId(){
		return "inpassword_b2c@sharklasers.com";
	}
