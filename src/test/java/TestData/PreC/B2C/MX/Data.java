...
public class Data extends B2CData {
	...
	public String getHomePageUrl() {
		return TestData.PreC.EnvData.HttpsDomain + "/mx/es/mxweb";
	}
	...
	public String getTeleSalesUrl() {
		// TODO Auto-generated method stub
		return TestData.PreC.EnvData.TeleSalesDomain + "/mx/es/mxweb";
	}
	...
	public String getDefaultAccessoryPN() {
		if (ACC != null) {
			...
			ACC = daoService.getProductNB("MX", "Accessory","PreC");
	...
	public String getResetPasswordId(){
		return "mxpassword_b2c@sharklasers.com";
	}
