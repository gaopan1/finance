package TestData.PreC.B2C.CO_OUTLET;
...
public class Data extends B2CData {
	...
	public String getHomePageUrl() {
		return TestData.PreC.EnvData.HttpsDomain + "/co/es/cooutlet";
	}
	...
	public String getDefaultMTMPN() {
		...
		if (MTM != null) {
			...
			MTM = daoService.getProductNB("CO", "MTM","PreC");
	...
	public String getDefaultMTMPN2() {
		...
		if (MTM != null) {
			...
			MTM = new ArrayList<String>();
			MTM = daoService.getProductNB2("CO", "MTM","PreC");
	...
	public String getTeleSalesUrl() {
		// TODO Auto-generated method stub
		return TestData.PreC.EnvData.TeleSalesDomain + "/co/es/cooutlet";
	}
	...
	public String getDefaultAccessoryPN() {
		if (ACC != null) {
			...
			ACC = daoService.getProductNB("CO_OUTLET", "Accessory","PreC");
	...
	public String getResetPasswordId(){
		return "cooutletpassword_b2c@sharklasers.com";
	}
