package TestData.PreC.B2C.US_SMB;
...
public class Data extends B2CData {
	...
	public String getHomePageUrl() {
		return TestData.PreC.EnvData.HttpsDomain + "/us/en/smbpro";
	}
	...
	public String getTeleSalesUrl() {
		// TODO Auto-generated method stub
		return TestData.PreC.EnvData.TeleSalesDomain + "/us/en/smbpro";
	}
	...
	public String getDefaultAccessoryPN() {
		if (ACC != null) {
			...
			ACC = daoService.getProductNB("US_SMB", "Accessory","PreC");
	...
	public String getResetPasswordId(){
		return "ussmbpassword_b2c@sharklasers.com";
	}
