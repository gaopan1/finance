package TestData.PreC.B2C.USEPP;
...
public class Data extends B2CData {
	...
	public String getHomePageUrl() {
		return TestData.PreC.EnvData.HttpsDomain + "/us/en/lenovousepp";
	}
	...
	public String getDefaultMTMPN() {
		...
		if (MTM != null) {
			...
			MTM = daoService.getProductNB("USEPP", "MTM" ,"PreC");
	...
	public String getDefaultMTMPN2() {
		...
		if (MTM != null) {
			...
			MTM = new ArrayList<String>();
			MTM = daoService.getProductNB2("USEPP", "MTM","PreC");
	...
	public String getLoginID() {
		// TODO Auto-generated method stub
		return "testusepp@sharklasers.com";
	}
	...
	public String getDefaultCTOPN() {
		...
		CTO = daoService.getProductNB("USEPP", "CTO" ,"PreC");
		if (CTO.get(0) != null) {
			return CTO.get(0);
		} else {
			// TODO Auto-generated method stub
	...
	public String getTeleSalesUrl() {
		// TODO Auto-generated method stub
		return TestData.PreC.EnvData.TeleSalesDomain + "/us/en/lenovousepp";
	}
	...
	public String getDefaultAccessoryPN() {
		if (ACC != null) {
			...
			ACC = daoService.getProductNB("USEPP", "Accessory","PreC");
	...
	public String getResetPasswordId(){
		return "usepppassword_b2c@sharklasers.com";
	}
