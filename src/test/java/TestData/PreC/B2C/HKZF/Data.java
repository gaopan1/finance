package TestData.PreC.B2C.HKZF;
...
public class Data extends B2CData {
	...
	public String getHomePageUrl() {
		return TestData.PreC.EnvData.HttpsDomain + "/hk/zf/hkweb";
	}
	...
	public String getDefaultMTMPN() {
		...
		return "80TU0003HH";
			...
			MTM = daoService.getProductNB("HKZF", "MTM","PreC");
	...
	public String getDefaultMTMPN2() {
		...
		if (MTM != null) {
			...
			MTM = new ArrayList<String>();
			MTM = daoService.getProductNB2("HKZF", "MTM","PreC");
	...
	public String getLoginID() {
		// TODO Auto-generated method stub
		return "testhkzh@sharklasers.com";
	}
	...
	public String getDefaultCTOPN() {
		...
		CTO = daoService.getProductNB("HKZF", "CTO" ,"PreC");
		if (CTO.get(0) != null) {
			return CTO.get(0);
		} else {
			return null;
	...
	public String getTeleSalesUrl() {
		// TODO Auto-generated method stub
		return TestData.PreC.EnvData.TeleSalesDomain+ "/hk/zf/hkweb";
	}
	...
	public String getDefaultAccessoryPN() {
		if (ACC != null) {
			...
			ACC = daoService.getProductNB("HKZF", "Accessory","PreC");
	...
	public String getResetPasswordId(){
		return "hkzfpassword_b2c@sharklasers.com";
	}
