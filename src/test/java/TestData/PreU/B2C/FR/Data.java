...
public class Data extends B2CData {
	...
	public String getHomePageUrl() {
		return TestData.PreC.EnvData.HttpsDomain + "/fr/fr/frweb";
	}
	...
	public String getDefaultMTMPN() {
		...
		return "";
			...
			MTM = daoService.getProductNB("FR", "MTM","PreC");
	...
	public String getDefaultMTMPN2() {
		...
		if (MTM != null) {
			...
			MTM = new ArrayList<String>();
			MTM = daoService.getProductNB2("FR", "MTM","PreC");
	...
	public String getDefaultCTOPN() {
		...
		CTO = daoService.getProductNB("FR", "CTO","PreC");
		if (CTO.get(0) != null) {
			return CTO.get(0);
		} else {
		return "";
	...
	public String getTeleSalesUrl() {
		// TODO Auto-generated method stub
		return TestData.PreC.EnvData.TeleSalesDomain + "/fr/fr/frweb";
	}
	...
	public String getDefaultAccessoryPN() {
		if (ACC != null) {
			...
			ACC = daoService.getProductNB("FR", "Accessory","PreC");
	...
	public String getResetPasswordId(){
		return "frpassword_b2c@sharklasers.com";
	}
