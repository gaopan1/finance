package TestData.PreU.B2C.JPEPP;
...
public class Data extends B2CData {
	...
	public String getHomePageUrl() {
		return TestData.PreC.EnvData.HttpsDomain + "/jp/ja/jpepp_lenovo";
	}
	...
	public String getDefaultMTMPN() {
		...
		if (MTM != null) {
			...
			MTM = daoService.getProductNB("JPEPP", "MTM" ,"PreC");
	...
	public String getDefaultMTMPN2() {
		...
		if (MTM != null) {
			...
			MTM = new ArrayList<String>();
			MTM = daoService.getProductNB2("JPEPP", "MTM","PreC");
	...
	public String getLoginID() {
		// TODO Auto-generated method stub
		return "testjpepp@sharklasers.com";
	}
	...
	public String getDefaultCTOPN() {
		...
		CTO = daoService.getProductNB("JPEPP", "CTO" ,"PreC");
		if (CTO.get(0) != null) {
			return CTO.get(0);
		} else {
			return null;
	...
	public String getTeleSalesUrl() {
		// TODO Auto-generated method stub
		return TestData.PreC.EnvData.TeleSalesDomain + "/jp/ja/jpepp_lenovo";
	}
	...
	public String getDefaultAccessoryPN() {
		if (ACC != null) {
			...
			ACC = daoService.getProductNB("JPEPP", "Accessory","PreC");
	...
	public String getResetPasswordId(){
		return "jpepppassword_b2c@sharklasers.com";
	}
