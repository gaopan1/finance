...
public class Data extends B2CData {
	...
	public String getHomePageUrl() {
		return TestData.PreC.EnvData.HttpsDomain + "/co/es/coweb";
	}
	...
	public String getTeleSalesUrl() {
		// TODO Auto-generated method stub
		return TestData.PreC.EnvData.TeleSalesDomain + "/co/es/coweb";
	}
	...
	public String getDefaultAccessoryPN() {
		if (ACC != null) {
			...
			ACC = daoService.getProductNB("CO", "Accessory","PreC");
	...
	public String getResetPasswordId(){
		return "copassword_b2c@sharklasers.com";
	}
