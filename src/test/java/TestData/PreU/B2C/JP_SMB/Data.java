package TestData.PreU.B2C.JP_SMB;
...
public class Data extends B2CData {
	...
	public String getHomePageUrl() {
		return TestData.PreC.EnvData.HttpsDomain + "/jp/ja/jpsmbpro";
	}
	...
	public String getDefaultMTMPN() {
		...
		if (MTM != null) {
			...
			MTM = daoService.getProductNB("JP_SMB", "MTM" ,"PreC");
	...
	public String getDefaultMTMPN2() {
		...
		if (MTM != null) {
			...
			MTM = new ArrayList<String>();
			MTM = daoService.getProductNB2("JP_SMB", "MTM","PreC");
	...
	public String getDefaultCTOPN() {
		...
		CTO = daoService.getProductNB("JP_SMB", "CTO" ,"PreC");
		if (CTO.get(0) != null) {
			return CTO.get(0);
		} else {
			// TODO Auto-generated method stub
	...
	public String getTeleSalesUrl() {
		// TODO Auto-generated method stub
		return TestData.PreC.EnvData.TeleSalesDomain + "/jp/ja/jpsmbpro";
	}
	...
	public String getDefaultAccessoryPN() {
		if (ACC != null) {
			...
			ACC = daoService.getProductNB("JP_SMB", "Accessory","PreC");
	...
	public String getResetPasswordId(){
		return "jpsmbpassword_b2c@sharklasers.com";
	}
