package TestData.PreU.B2C.JP_OUTLET;
...
public class Data extends B2CData {
	...
	public String getHomePageUrl() {
		return TestData.PreC.EnvData.HttpsDomain + "/jp/ja/jpoutlet";
	}
	...
	public String getTeleSalesUrl() {
		// TODO Auto-generated method stub
		return TestData.PreC.EnvData.TeleSalesDomain + "/jp/ja/jpoutlet";
	}
	...
	public String getDefaultAccessoryPN() {
		if (ACC != null) {
			...
			ACC = daoService.getProductNB("JP_OUTLET", "Accessory","PreC");
	...
	public String getResetPasswordId(){
		return "jpoutletpassword_b2c@sharklasers.com";
	}
