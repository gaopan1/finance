package TestData.QAS;

public class EnvData extends TestData.EnvData {
	public static String HttpDomain = "http://LIeCommerce:M0C0v0n3L!@qas-hybris.lenovo.com";
	public static String HttpsDomain = "https://LIeCommerce:M0C0v0n3L!@qas-hybris.lenovo.com";
	public static String TeleSalesDomain = "https://LIeCommerce:M0C0v0n3L!@qas-hybris.lenovo.com";
	public static String PriceServiceDomain="http://service-price.dit1.online.lenovo.com/api/v1/price/getPrice?productCodes=";
	public static String ProductServiceDomain="http://service-product.dit1.online.lenovo.com/api/v1/product/";
	public static String CategoryServiceAllDomain="http://service-catalog.dit1.online.lenovo.com/api/v1/internal/catalog/all";
	public static String CategoryLaptopTreeDomain="ttp://service-catalog.dit1.online.lenovo.com/api/v1/catalog/children/Laptops";
	public static String CategoryGetChildrenDomain="http://service-catalog.dit1.online.lenovo.com/api/v1/catalog/children/";
	public static String AccountAuthenticateServiceDomain="http://service-account.dit1.online.lenovo.com/api/v1/user/authenticate?id=";
	...
	public static String B2CUserAccountServiceDomain="http://service-account.dit1.online.lenovo.com/api/v1/user/access/";
	public static String B2BUserAccountServiceDomain="http://service-account.dit1.online.lenovo.com/api/v1/user/b2b/access/";
	public static String AccountAuthorizationServiceDomain="http://service-account.dit1.online.lenovo.com/api/v1/user/authorization/";
	public static String SitDomain = "http://web-content.sit.online.lenovo.com/";
	public static String LenovoProdUS = "http://www3.lenovo.lenovo.com/";
	public static String getStockDomain="http://service-stock.dit1.online.lenovo.com/api/v1/stock/";
	public static String ReserveStockDomain="http://service-stock.dit1.online.lenovo.com/api/v1/stock/reserve";
	public static String ReleaseStockDomain="http://service-stock.dit1.online.lenovo.com/api/v1/stock/release";
	public static String purchaseStockServiceDomain="http://service-stock.dit1.online.lenovo.com/api/v1/stock/purchase";
	public static String AccountAuthorizationServiceDomainv2="http://service-account.sit.online.lenovo.com/api/v2/user/authorization/access";
	...
	public static String AccountAuthenticateServiceDomainv2="http://service-account.sit.online.lenovo.com/api/v1/user/authenticate?";
	...
	public static String accountGenerateTokenDomain="http://service-account.dit1.online.lenovo.com/api/v2/user/authenticate/token?type=";
