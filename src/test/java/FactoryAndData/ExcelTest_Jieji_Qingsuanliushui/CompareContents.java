...
import TestScript.ExcelTest_Jieji_Qingsuanliushui.CompareContetntsTest;
...
public class CompareContents {
	...
	public static Object[][] Data16389() {
		return new Object[][] { 
			...
			{ 	
				...
				"C:\\Users\\gaopan\\Desktop\\接机清算流水\\result\\Contents.xls",
	...
	public Object[] createTest(String sourceFile,
		...
		tests[0] = new CompareContetntsTest(sourceFile,
									 destinationFile,
