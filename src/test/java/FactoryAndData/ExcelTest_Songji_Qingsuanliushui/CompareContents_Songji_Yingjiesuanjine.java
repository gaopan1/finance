...
import TestScript.ExcelTest_Songji_Qingsuanliushui.CompareContents_Songji_Calclate_Yingjiesuanjine;
...
public class CompareContents_Songji_Yingjiesuanjine {
	...
	public Object[] createTest(String sourceFile,
		...
		tests[0] = new CompareContents_Songji_Calclate_Yingjiesuanjine(sourceFile,
									 destinationFile,
									 sheetName,
									 resultSheetName,
									 dingdanhao,
