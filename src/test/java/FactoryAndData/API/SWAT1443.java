...
public class SWAT1443 {
	@DataProvider(name = "SWAT1443")
	public static Object[][] DataServiceDemo() {
		return Common
				.getFactoryData(
						...
						}, PropsUtils.getTargetStore("SWAT1443"));
	}

	@Factory(dataProvider = "SWAT1443")
	public Object[] createTest(String countryValue, String productNo,
			String context, String releasedAmount, String parameter,
			String parameter2, String updateResult) {

		Object[] tests = new Object[1];

		tests[0] = new SWAT1443Test(countryValue, productNo, context,
				releasedAmount, parameter, parameter2, updateResult);
