...
import TestScript.ExcelTest_Jiudian_EcouponSplitting.CompareContentsTest_Jine;
...
public class CompareContentsData_Jine {
	...
	public Object[] createTest(String sourceTable,
		...
		tests[0] = new CompareContentsTest_Jine(sourceTable,destinationTable,caseName,pay_sheetName,getPayColumnName,account_sheetName,getAccountColumnName,result_sheetName,getPayJine,getAccount_youhuiquan);
