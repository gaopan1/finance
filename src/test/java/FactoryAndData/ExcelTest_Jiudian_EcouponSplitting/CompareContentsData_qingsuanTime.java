...
import TestScript.ExcelTest_Jiudian_EcouponSplitting.CompareContentsTest_qingsuanTime;
...
public class CompareContentsData_qingsuanTime {
	...
	public Object[] createTest(String sourceTable,
		...
		tests[0] = new CompareContentsTest_qingsuanTime(sourceTable,destinationTable,caseName,pay_sheetName,getPayColumnName,account_sheetName,getAccountColumnName,result_sheetName,getPayJine,getAccount_youhuiquan);
